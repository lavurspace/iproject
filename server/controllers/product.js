	...
	static async gemini(req, res, next) {
		try {
			...
			const genAi = new GoogleGenerativeAI(
				"AIzaSyCj5aPLGolQtxeGM48qCapP5kEKqwRHUOM"
			);
			const model = genAi.getGenerativeModel({ model: "gemini-pro" });

			const prompt = `Act as a music equipment expert. Given this list of products: ${JSON.stringify(
				products
			)}, provide 10 recommended products. Requirements:
